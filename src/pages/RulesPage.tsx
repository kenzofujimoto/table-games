    ...
    <AppShell>
      <main className="content-page rules-manual">
        ...
        <div className="rules-grid">
          ...
          <section className="rule-card"><Handshake /><h2>Negociação entre pessoas</h2><p>No seu turno, proponha exatamente o que oferece e o que deseja, escolhendo os destinatários. Um destinatário pode aceitar ou recusar. A troca só conclui se ambos ainda tiverem todas as cartas anunciadas.</p><p>Promessas futuras e doações fora da proposta não fazem parte das regras.</p></section>
